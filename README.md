...
To run the full real-WireGuard stack on a single public host (e.g. a KVM VPS) behind automatic HTTPS, use the artifacts in [`deploy/`](deploy/):
...
per-OSS license & commercial-use notes live in the private private notes.
...
Verified via Chrome DevTools: all 13 React Router paths render their correct headings,
