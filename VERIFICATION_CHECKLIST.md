...
| 6.9 | No hosting-provider names, hostnames, IPs or credentials in tracked files | `git ls-files \| xargs grep -lniE 'private-notes\|<demo-host>'` -> empty; gitleaks runs in CI. |
