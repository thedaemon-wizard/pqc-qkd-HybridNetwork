...
$$\boxed{\;Q_\mu \;=\; Y_0 + 1 - e^{-\eta\mu}\;}$$

and the **quantum bit error rate** is (Eq. 11):

$$\boxed{\;E_\mu \;=\; \frac{e_0 Y_0 + e_d\left(1 - e^{-\eta\mu}\right)}{Q_\mu}\;}
\qquad e_0 = \tfrac12$$
...
$$\boxed{\;R \;\geq\; q\left\{-Q_\mu f_{\mathrm{EC}}\,h_2(E_\mu) \;+\; Q_1\left[1 - h_2(e_1)\right]\right\}\;}$$
